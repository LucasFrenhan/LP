...
#ifdef ex1
/* Exercício 1 -  As ligacoes telefonicas sao cobradas pela sua duracao.
 ...
 int main ()
 {
    ...
    do
    {
        ...
        printf("\nDigite o instante inicial da ligação em horas: ");
        scanf("%d", &h_inicial);
        ...
        printf ("\nA duração da ligação foi de %d:%d:%d\n", total_h, total_min, total_seg);
    ...
    do
    {
        ...
        do
        {
            ...
            if (x == '=')
            {
                ...
                printf("UUHUUU! Acertei o número.\n");
                getchar();
            }
            else
            {
...
#ifdef ex5
/* Exercicio 5 - Um posto está vendendo combustiveis com a seguinte tabela de descontos:
   ...
   combustivel (codificado da seguinte forma: A- Álcool, G-gasolina). Calcule e
...
int main()
{
    ...
    do
    {
        ...
        printf("------------------------------------\n");
        printf("\nQuantos litros voce deseja abastecer? ");
        scanf("%d",&litro);
