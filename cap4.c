...
#ifdef ex2
/* Exercicio 2 - Receba via teclado valores do tipo int para uma vetor 5 x 5. Receba via
...
#ifdef ex3
/* Exercicio 3 - Defina 2 vetores bidimensionais do tipo inteiro de 2x3. Escreva um programa
...
int main()
{
    ...
    do
    {
        ...
        printf("Esse programa tem como objetivo imprimir na tela o indice e os valores dos vetores.\n");
        criaVetorA();
        criaVetorB();
        criaVetorC();
        imprimiVetorA();
...
#ifdef ex5
/* Exercicio 5 - Receba via teclado 10 valores inteiros e ordene por ordem crescente assim
...
void verificaVetor()
{
    ...
    for(i=0; i<10; i++)
    {
        for(j=i+1; j<10; j++)
        {
            if(vetorANA[i]>vetorANA[j])
            {
                numero = vetorANA[i];
                vetorANA[i] = vetorANA[j];
                vetorANA[j] = numero;
            }
        }
    }
