...
/* Exercício 1 -  As ligacoes telefonicas são cobradas pela sua duracao.
 ...
 int main ()
 {
    ...
    do
    {
        ...
        printf("\nPara encerrar o programa digite qualquer numero.\n");
        scanf("%d", &result);
    } while (result == 1);
}
#endif // ex1
...
int main ()
{
    ...
    do
    {
        ...
        printf("Caso o seu numero seja maior, use >\n");
        printf("Caso o seu numero seja menor, use <\n");
        printf("Caso seja o numero pensado, use =\n");
...
int main ()
{
    ...
    do
    {
        ...
        media = soma / cont;
        printf("\nA media dos números inteiros positivos é: %.2f\n", media);
